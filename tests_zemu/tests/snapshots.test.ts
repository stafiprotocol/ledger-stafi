...
describe('SR25519', function () {
  ...
  test('s-sign_large_nomination snapshots', async function () {
    ...
    try {
      ...
      // Wait until we are not in the main menu
      await sim.waitUntilScreenIsNot(sim.getMainMenuSnapshot())
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00000.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00001.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00002.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00003.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00004.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00005.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00006.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00007.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00008.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00009.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00010.png")
      await sim.clickRight()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00011.png")
      await sim.clickBoth()
      await sim.snapshot(SnapShotsPath + "/s-sign_large_nomination/00012.png")
    } finally {
      await sim.close()
    }
  })
